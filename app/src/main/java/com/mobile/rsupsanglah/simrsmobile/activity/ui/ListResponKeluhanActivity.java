...
public class ListResponKeluhanActivity extends AppCompatActivity implements listResponKeluhanAdapter.listAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_respon_keluhan);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ListResponKeluhanActivity.this, DashboardActivity.class);
    ...
    private void getListRespon(final String id_pegawai) {
        ...
        class getListRespon1 extends AsyncTask<Void, Void, String> {
            private final WeakReference<ListResponKeluhanActivity> mActivityRef;

            private getListRespon1(ListResponKeluhanActivity activity) {
            ...
            protected String doInBackground(Void[] params) {
                ...
                try {
                    HttpRequest req = new HttpRequest(ipAddress + SimrsmConstant.ServiceType.URLRESPONKELUHAN + "&user="+ id_pegawai);/////////////////////////+ pegawai id (show based on id)
                    response = req.prepare(HttpRequest.Method.POST).withData(map).sendAndReadString();
                    Log.e("LIST RESPON KELUHAn", ipAddress + SimrsmConstant.ServiceType.URLRESPONKELUHAN + "&user="+ id_pegawai);
                } catch (IOException e) {
        ...
        new getListRespon1(ListResponKeluhanActivity.this).execute();
    }
        ...
        if (response.equals("")) {
            ...
            try {
                ...
                for (int i = 0; i < userArray.length(); i++) {
                    ...
                    //////////////////////////status if == 5, don't show on recyclerview
    ...
    public void onContactSelected(listResponKeluhan contact) {
        Intent intent = new Intent(ListResponKeluhanActivity.this, ViewResponKeluhanActivity.class);
