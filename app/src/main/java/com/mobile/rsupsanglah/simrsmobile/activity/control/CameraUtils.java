...
import com.mobile.rsupsanglah.simrsmobile.BuildConfig;
import com.mobile.rsupsanglah.simrsmobile.activity.ui.CameraActivity;
import com.mobile.rsupsanglah.simrsmobile.activity.ui.ImagePreviewActivity;
...
public class CameraUtils {
    ...
    public static File getOutputMediaFile(int type) {
        ...
        File mediaFile;
        String order_id = SharedPreference.getInstance(ImagePreviewActivity.getAppContext()).getActtoFrag();
        if (type == CameraActivity.MEDIA_TYPE_IMAGE) {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator
                    + order_id + "#" + "IMG_" + timeStamp + "." + CameraActivity.IMAGE_EXTENSION);
