...
public class RegisterChooseActivity extends AppCompatActivity {
    ...
    CardView cvPegawai,cvResiden, cvHelp;
    private static final int REQUEST_CODE = 1234;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registerchoose);
        loadTutorial();


        cvPegawai = (CardView) findViewById(R.id.android_card_view_pegawai);
        cvPegawai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getApplicationContext(), RegisterActivity.class);
                i.putExtra("JENIS", "PEGAWAI");
                startActivity(i);
                finish();
            }
        });

        cvResiden= (CardView) findViewById(R.id.android_card_view_residen);
        cvResiden.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getApplicationContext(), RegisterActivity.class);
                i.putExtra("JENIS", "RESIDEN");
                startActivity(i);
                finish();
            }
        });

        cvHelp= (CardView) findViewById(R.id.android_card_view_help);
    ...
    private ArrayList<TutorialItem> getTutorialItems(Context context) {
        ...
        TutorialItem tutorialItem0 = new TutorialItem("", "",
                R.color.slide_0, R.drawable.tut_page_1_front,  R.drawable.tut_page_0_background);

        TutorialItem tutorialItem1 = new TutorialItem(R.string.slide_1_african_story_books, R.string.slide_1_deskripsi,
