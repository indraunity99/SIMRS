...
public class LaporanDikerjakanActivity extends AppCompatActivity implements listResponKeluhanAdapter.listAdapterListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LaporanDikerjakanActivity.this, DashboardActivity.class);
    ...
    private void getListRespon(final String id_pegawai) {
        ...
        class getListRespon1 extends AsyncTask<Void, Void, String> {
            private final WeakReference<LaporanDikerjakanActivity> mActivityRef;

            private getListRespon1(LaporanDikerjakanActivity activity) {
            ...
            protected String doInBackground(Void[] params) {
                ...
                try {
                    HttpRequest req = new HttpRequest(ipAddress + SimrsmConstant.ServiceType.URLDIKERJAKAN + "&user="+ id_pegawai);/////////////////////////+ pegawai id (show based on id)
                    response = req.prepare(HttpRequest.Method.POST).withData(map).sendAndReadString();
                    Log.e("list all responses", ipAddress + SimrsmConstant.ServiceType.URLDIKERJAKAN + "&user="+ id_pegawai);
                } catch (IOException e) {
        ...
        new getListRespon1(LaporanDikerjakanActivity.this).execute();
    }
...
//            finish();
    ...
    public void onContactSelected(listResponKeluhan contact) {
        Intent intent = new Intent(LaporanDikerjakanActivity.this, ViewResponKeluhanActivity.class);
        intent.putExtra("item_click",contact.getId());
        intent.putExtra("dikerjakan", "dikerjakan");
